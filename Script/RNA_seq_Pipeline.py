...
This script processes GEO2R output, performs pathway analysis using Enricher,
...
class Config:
    ...
    OUTPUT_FILE = "rna_seq_analysis_results2.xlsx"  # Change to desired output file name
...
class RNASeqAnalysisPipeline:
    ...
    def __init__(self, disease_name: str, input_file: Optional[str] = None):
        """
    ...
    def _detect_columns(self):
        ...
        """
        assert self.df is not None, "DataFrame not loaded yet"
        # Detect gene column
    ...
    def run_pipeline(self):
        ...
        print(f"{'='*60}")
        print(f"Summary:")
        print(f"  Total genes analyzed: {len(self.df) if self.df is not None else 0}")
